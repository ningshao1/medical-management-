...
<script>
import basicsInfo from "./temps/oneStepTemp"; //基础信息
import equipmentInfo from './temps/TwoStepTemp'//保养设备分类
import elementInfo from "./temps/ThreeStepTemp";//保养要素
export default {
    data() {
        return {
            list: null,
    ...
    methods: {
        ...
        //编辑事件
        edit(){
            this.$router.push({name:"inspection-template-edit",query:this.$route.query})
        },
        format(data){
            this.value={
                    mName:data.mName,
