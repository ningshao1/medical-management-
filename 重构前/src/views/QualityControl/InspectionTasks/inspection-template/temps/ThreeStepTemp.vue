    ...
    <div style="padding:0 30px;">
        ...
        <div class="category">
            <div class="categoryLeft">
                <div class='title'>检查类别 <span @click='addElement' v-if="false">+ 新增项</span></div>
                <div class='categoryScroll'>
                    <ul>
                        <li v-for="(item,i) in CheckCategoryList" :key='i' @click='trigger(item,i)' :class='triggerIndex==i?"click_li":"click_lis"'>
                            ...
                            <span @click.stop='del(item,i)' v-if="false">删除</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="categoryRight">
                ...
                <div class="r_right r_wrap">
                    <div class='r_title'>
                        巡检要素
                        <span>* 所有检查项的评判结果分为二等：合格、不合格</span>
                    </div>
                    <ul>
...
export default {
    ...
    watch: {
        CheckCategoryList() {
            this.trigger(this.CheckCategoryList[0], 0);
        },
        content(data){
            this.clickedIndex=0;
